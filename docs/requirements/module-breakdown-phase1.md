...
- **Admin Console** → Full spec exists in [docs/design/admin-console-ux-spec.md](docs/design/admin-console-ux-spec.md)
...
**Related Documents:**
- [docs/design/student-authentication-and-progress-tracking-spec.md](docs/design/student-authentication-and-progress-tracking-spec.md)
- [docs/design/ux-rewards-engagement-spec.md](docs/design/ux-rewards-engagement-spec.md)
- [docs/design/admin-console-ux-spec.md](docs/design/admin-console-ux-spec.md)
- [docs/worksheet_architecture.md](docs/worksheet_architecture.md)
- [docs/specs/auth-online-offline-reporting-spec.md](docs/specs/auth-online-offline-reporting-spec.md)
