...
1. `docs/worksheet_architecture.md`
2. `docs/specs/platform-module-breakdown-auth-first.md`
3. `docs/operations/NEXT_PHASE_MASTER_DOSSIER.md`
4. `docs/operations/PLATFORM_TECHNICAL_STATUS.md`
...
File: `docs/specs/api-security-auth-model.md`
...
File: `docs/worksheet_architecture.md`
...
File: `docs/specs/platform-module-breakdown-auth-first.md`
...
File: `docs/specs/certificate-completion-options.md`
...
File: `docs/operations/NEXT_PHASE_MASTER_DOSSIER.md`
...
File: `docs/operations/PLATFORM_TECHNICAL_STATUS.md`
...
- `docs/specs/ui-flow-master-spec.md`
- `docs/design/auth-practice-reporting-ux-spec.md`
- `docs/design/student-authentication-and-progress-tracking-spec.md`
- `docs/design/admin-console-ux-spec.md`

## Operations and Deployment Architecture Docs

Use these if you want infra, deployment, and production operation review:

- `docs/operations/aws-services-inventory.md`
- `docs/operations/admin-control-plane-operations-spec.md`
- `docs/operations/env-based-iac-deployment-plan.md`
- `docs/LOCAL_DEV_STRATEGY.md`
...
5. `docs/operations/NEXT_PHASE_MASTER_DOSSIER.md`

## Review Note

Current coverage is good but fragmented:
- `docs/worksheet_architecture.md` is the clearest single architecture/diagram source for generator design.
- `docs/specs/platform-module-breakdown-auth-first.md` is the clearest single solution source for the broader platform.
