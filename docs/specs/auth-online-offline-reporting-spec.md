...
# File: docs/specs/auth-online-offline-reporting-spec.md
# Version: 1.0
# Date: 2026-03-24
...
Validation depth and test matrix for this module are detailed in [docs/qa/auth-mode-reporting-qa-spec.md](docs/qa/auth-mode-reporting-qa-spec.md).
