...
1. `docs/specs/auth-online-offline-reporting-spec.md`
2. `docs/design/student-authentication-and-progress-tracking-spec.md`
3. `docs/design/auth-practice-reporting-ux-spec.md`
4. `docs/qa/auth-mode-reporting-qa-spec.md`
